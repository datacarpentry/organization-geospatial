...
reference system. The earth is flattened and subdivided Easting zones,
numbered 0-60 (equivalent to longitude), and the Northing bands,
lettered C-X (equivalent to latitutede). At a smaller scale the grid is further
subdivided into 1000m x 1000m grids. The coordinates for the Harvard Forest could be written as: Zone 18T, 730782m Easting, 4712631m Northing. The units are in meters  
