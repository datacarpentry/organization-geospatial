---
title: "Answer a Spatio-temporal Research Question with Data - Where to Start?"
teaching: 30
exercises: 30
questions:
 - TBD
...
Boundary.US <- readOGR("data/NEON-DS-Site-Layout-Files/US-Boundary-Layers",
...
<figure>
	<a href="{{ site.baseurl }}/fig/dc-spatio-temporal-intro/NDVI_Plot.png">
	<img src="{{ site.baseurl }}/fig/dc-spatio-temporal-intro/NDVI_Plot.png"></a>
	<figcaption>
...
<figure>
	<a href="{{ site.baseurl }}/fig/dc-spatio-temporal-intro/NDVI-Landsat-RS.png">
	<img src="{{ site.baseurl }}/fig/dc-spatio-temporal-intro/NDVI-Landsat-RS.png"></a>
