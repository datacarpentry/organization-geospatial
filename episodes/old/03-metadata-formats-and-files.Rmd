...
CHM.HARV <- raster("data/NEON-DS-Airborne-Remote-Sensing/HARV/CHM/HARV_chmCrop.tif")
crs(CHM.HARV)
extent(CHM.HARV)

# 2. the extent and CRS should be the same
# 3. The extent and CRS are different.
ndvi1.HARV <- raster("data/NEON-DS-Landsat-NDVI/HARV/2011/ndvi/005_HARV_ndvi_crop.tif")
crs(ndvi1.HARV)
extent(ndvi1.HARV)
```
