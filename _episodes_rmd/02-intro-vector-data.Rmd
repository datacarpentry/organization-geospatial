...
shapefile.
* **Object type** - whether the shapefile includes points, lines, 
or polygons.
* **Coordinate reference system (CRS)** - we will introduce this concept in [a later episode](({{ base.url }}/03-crs/)).
* **Other attributes** - ror example, a line shapefile that contains
the locations of
