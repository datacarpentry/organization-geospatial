...
In the data-tutorials in this workshop series <<LINK TO OVERALL WORKSHOP LANDING PAGE>>, 
...
![ ]({{ site.baseurl }}/images/rfigs/00-spatio-temporal-science-questions/Field-Site-Map-1.png) 
...
Our goal is to create plots of temperature, precipitation and the greening and 
...
Where do we start to quantify the timing of plant greening and browning?
...
capturing images of the earth's surface- continuouslly. The Landsat sensor,  
captures images of the same area, every 16 days which makes it a very powerful spatio-temporal
