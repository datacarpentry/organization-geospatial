...
<figure>
	<a href="https://xxxx">
	<img src="https://xxxx"></a>
	<figcaption> TO BE ADDED NDVI PLOT FROM VIDEO. 
...
[*Introduction to Working With Vector Data in R* tutorial series]({{ site.baseurl }}/tutorial-series/vector-data-series/).
...
[ *The Basics of LiDAR - Light Detection and Ranging - Remote Sensing* tutorial]({{ site.baseurl }}/self-paced-tutorial/1_About-LiDAR-Data-Light-Detection-and-Ranging_Activity1/)
* Learn more about LiDAR canopy height and digital elevation models in the NEON Data Skills 
[*What is a CHM, DSM and DTM? About Gridded, Raster LiDAR Data* tutorial]({{ site.baseurl }}/self-paced-tutorial/2_LiDAR-Data-Concepts_Activity2/)
...
This 
[Intro to Working With Spatio-Temporal Data and Data Management series]({{ site.baseurl }}/tutorial-series/spatial-data-management-series/)
