...
support one's research question. It covers some of the key data sources and 
providers and places that one can look to find data for a study area or research
question."
...
research question. It covers some of the key data sources and providers and 
...
<figure>
	...
	<figcaption> A nice overview graphic of the research topic, question and data
	needed to begin to address the question. ACTUAL GRAPHIC IN CONSTRUCTION
...
Our science topic for all of the tutorials in this series is plant phenology. Our 
goal is to:
...
3. Optionally - we'd like to understand how / if "1" and "2" above vary at 
different sites.
...
```{r field-site-map, echo=FALSE, include=TRUE, results="hide", warning=FALSE}
...
### Science Goals in the Work with Spatio-temporal Data in R Series

In the In the 
[Work with Spatio-temporal Data in R series]({{ site.baseurl }}/tutorial-series/neon-dc-phenology-series/),
...
<figure>
	<a href="https://xxxx">
	<img src="https://xxxx"></a>
	<figcaption> Plot of NDVI that colin made with the vegetation below and the 
	plot above.  Source: National Ecological Observatory Network (NEON)  
	</figcaption>
</figure>
...
What are some potential sources of data that might be useful to
address our phenology question? How would you go about finding these
data?
...
We can identify that types of data that we might need. We'd like to do the 
following:
...
* **Understand our field sites:** How big are the sites? How dense is the 
vegetation? Where are the field sites located? Are the sites accessible by roads
or difficult to get to? We also might want to create a map of our study 
...
#### Measuring Phenology at Different Scales
...
This video explains more about how high fidelity remote sensing cameras work.
...
We can visualize NDVI data and see the change in color (representing the change 
in the index) as the growing season progresses across the year. In this figure,
each plot presents a snapshot of the NDVI values across an area of 120m x 150m. 
...
<i class="fa fa-star"></i> **Data Tip:** NDVI can be calculated using any image
...
Search for any location of interest. Can decide? Try one of our study sites: 
Harvard Forest, Massachusetts, United States. 

1) Data from which Landsat sensors are available for your area? 
2) How is the quality of the images?
</div>
...
just like the pixels in the images we take with our camera phones. We will 
learn more about the raster format in 
[Spatial Intro 02: Spatial Data Formats -- Intro to Shapefiles (Vector Data) and GeoTiffs (Raster Data)]({{ site.baseurl }}/R/spatial-data-formats)
...
These *micrometeorological* measurements are recorded at weather stations across 
...
light intensity and more, at its field sites located across the United States. 
Data can be downloaded from the 
<a href="http://data.neonscience.org/browse-data?showTheme=atmos" target="_blank">
NEON data portal </a>. 
* <a href="http://fluxnet.ornl.gov" target="_blank">**FluxNet:** </a>
a network of towers located around the world. 
* <a href="http://www.ncdc.noaa.gov/data-access/land-based-station-data> **NOAA National Center for Environmental Information (formerly National Climatic Data Center):**</a>
from a
...
The micrometeorolgical data are available for download in text of Comma
Separated Value (`.csv`) format. To work with these data in `R`, we will need 
to understand how to work with date and time formats. 

[The **Introduction to Working With Time Series Data in Text Formats in R** tutorials]({{ site.baseurl }}/tutorial-series/tabular-time-series/) 
...
## Find Data to Characterize our Study Site

It is often useful to create maps that characterize our field sites. Maps are integral to planning site visits and plot locations prior to visiting.These maps
...
data but never be able to vist because they are too far away or visitation is 
...
* Get
<a href="http://earthexplorer.usgs.gov/" target="_blank"> LiDAR data from
the USGS.</a> )
...
This 
[Intro to Working With Spatio-Temporal Data and Data Management series]({{ site.baseurl }}/tutorial-series/neon-dc-phenology-series/)
...
* <a href="http://www.dataone.org/find-data" target="_blank"> DataOne</a>: a 
wide variety of data shared by different users.
* <a href="http://www.data.gov/" target="_blank"> US federal data portal (data.gov)</a>: This is the clearing-house for all types of US federal data. 
* <a href="http://www.geoplatform.gov/" target="_blank"> US federal spatial data portal</a>: provide geospatial data, services, and applications for use by the public and by government agencies and partners.
...
* <a href="http://www.ecologicaldata.org" target="_blank"> Ecological Data Wiki </a>: This wiki is designed to find & compile ecological datasets.

#### Additional Phenology Data Sources
* <a href="http://www.neonscience.org" target="_blank"> National Ecological 
Observatory Network (NEON) </a>: provide data from a continental-scale 
observation system with the purpose of examining ecological change over time. 
The data portal provides a wide diversity of standardized ecological data, 
including phenology, for all sites in the observatory network.
* <a href="https://www.usanpn.org/" target="_blank"> USA National Phenology Network </a>: a collaborative effort to collect phenology data
...
* <a href="http://phenology.cr.usgs.gov/get_data_main.php" target="_blank">USGS/EROS Center</a>: remote sensing phenology data
