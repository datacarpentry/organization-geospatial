...
CHM.HARV <- rast("NEON-DS-Airborne-Remote-Sensing/HARV/CHM/HARV_chmCrop.tif")
crs(CHM.HARV)
ext(CHM.HARV)

# 2. the extent and CRS should be the same
# 3. The extent and CRS are different.
#ndvi1.HARV <- rast("NEON-DS-Landsat-NDVI/HARV/2011/ndvi/005_HARV_ndvi_crop.tif")
#crs(ndvi1.HARV)
#ext(ndvi1.HARV)

## ----install-EML-package, results="hide", warning=FALSE------------------
# install R EML tools
# gosh, this stuff isn't in the lesson at all.
# removing 11/21/2024
#library("devtools")
