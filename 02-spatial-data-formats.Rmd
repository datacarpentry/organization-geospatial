...
<i class="fa fa-star"></i> **Data Note:** Wondering why we’re saying 
**directory** instead of **folder**? See our discussion of 
[Directory vs. Folder](http://neondataskills.org/R/Set-Working-Directory#directory-vs-folder).
{: .notice}
...
[*Convert from .csv to a Shapefile in R* tutorial](http://neondataskills.org/R/csv-to-shapefile-R/).
